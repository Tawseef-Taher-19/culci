...
$comment_show_obj = new lion();

if ($_GET['status'] == "comment") {
    $result = $comment_show_obj->comment_show($_GET['nid']);
}
        ...
        <div class="container-fluid admin_post">
            <div class="row justify-content-center">
                <div class="col-xl-6 admin_post_up">
                    <h2>ALL COMMENT IN THIS NEWS</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                        ...
                        <tbody>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="./delete_comment.php?status=delete&& id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-success" href="./reply_comment.php?status=reply&&id=<?php echo $row['id'];  ?>" role="button">Replyed</a>
                                    </td>
                                </tr>
