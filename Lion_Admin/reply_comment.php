...
if ($_GET['status'] == "reply") {
    $result = $comment_show_obj->showReply($_GET['id']);
}
                        ...
                        <tbody>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="./delete_reply.php?status=delete&& id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                    </td>
                                </tr>
