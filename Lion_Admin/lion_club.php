...
$lion_gal_show_obj = new lion();

$result = $lion_gal_show_obj->lion_gallery_show();
        ...
        <div class="container-fluid admin_post">
            <div class="row justify-content-center">
                <div class="col-xl-6 admin_post_up">
                    <h2>LION CLUB COMMITTEE</h2>
                </div>
                <div class="col-xl-6 admin_post_up">
                    <a href="./add_lion_member.php"><span>ADD MEMBER</span></a>
                </div>
            </div>
            <div class="row justify-content-center">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)) {   ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="./lion_club_edit.php?status=edit&&id=<?php echo $row['id'];  ?>" role="button">EDIT</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="./lion_club_delete.php?status=delete&&id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="./leo_lion_inactive.php?status=inactive&&role=1&&id=<?php echo $row['id'];  ?>" role="button">ADD INACTIVE</a>
                                    </td>
                                </tr>
