...
if(isset($_POST['btn'])){
    ...
    $blood_add_obj->blood_donor_add($data);
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 add_post_row">
                ...
                <form action="#" method="post">
                    ...
                    <div class="row mb-3">
                      <label for="colFormLabel" class="col-sm-2 col-form-label">IID</label>
                      <div class="col-sm-10">
      
                        <input type="number" name="iid" class="form-control" id="colFormLabel" placeholder="YOUR INTERNATIONAL ID">
                        
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="colFormLabel" class="col-sm-2 col-form-label">YOUR MOBILE</label>
                      <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" name="blood" class="form-control" id="colFormLabel" placeholder="YOUR BLOOD GROUP">
                    ...
                    <div class="row mb-3">
                        <label for="formFile" class="col-sm-2 col-form-label">LAST DONATED</label>
                        
                        <div class="col-sm-10">
        
                            <input class="form-control" type="date" id="formFile"name="last_donate">
