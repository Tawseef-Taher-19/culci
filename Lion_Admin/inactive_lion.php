...
$result = $lion_gal_show_obj->inactiveLeoLion(2);
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)) {   ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="./leo_lion_active.php?status=active&&role=1&&id=<?php echo $row['id'];  ?>" role="button">ADD ACTIVE</a>
                                    </td>
                                </tr>
