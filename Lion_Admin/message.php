...
$message_show_obj=new lion();

$result=$message_show_obj->message_show();
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <?php while($row=mysqli_fetch_assoc($result)) {  ?>
                           <tr>
                              ...
                              <td>
                                <a href="./message_seen.php?status=seen&&id=<?php echo $row['id'];  ?>"><?php echo $row['message']; ?></a>
                              </td>
                              <td>
                               <a class="btn btn-success" href="./replay.php?status=replay&&id=<?php echo $row['id']; ?>" role="button">REPLAY</a>
                               <a class="btn btn-success" href="./message_delete.php?status=delete&&id=<?php echo $row['id']; ?>" role="button">DELETE</a>
                              </td>
                              <td>
                                <span><?php if($row['replay']) echo "Replayed" ; else echo "Not Replayed" ;?></span>
                              </td>
                            </tr>
                        <?php  }  ?>
